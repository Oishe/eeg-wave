...
export class EmbedGameComponent implements OnInit, OnDestroy{
  ...
  class1:boolean; class2:boolean; class3:boolean; class4:boolean; //not actually per tile
  hover1:boolean; hover2:boolean; hover3:boolean; hover4:boolean; //per tile
  lit1:boolean; lit2:boolean; lit3:boolean; lit4:boolean; //per tile
  ...
  registerClick(event: Event) {
    ...
    let score = this.round;
    let timescore = [time, score];
