...
export class ButtonsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private recording: RecorderService
  ) {}

  ngOnInit() {
    this.playStopUnsubscribe = this.timerService.playStop$.subscribe(
      (res: any) => this.setPlay(res)
    );
    this.playStartUnsubscribe = this.recording.startStop$.subscribe(
      (res: any) => this.setPlayStart(res)
    );
  }
